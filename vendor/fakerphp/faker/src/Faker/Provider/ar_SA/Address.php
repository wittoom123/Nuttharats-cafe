...
class  extends \Faker\Provider\
{
    ...
    protected static $streetFormats = [
        '{{buildingNumber}} {{streetName}}',
        '{{buildingNumber}} {{streetName}} {{secondary}}',
    ];
    ...
    protected static $secondaryFormats = ['شقة رقم. ##', 'عمارة رقم ##'];
    ...
    {
        return static::numerify(static::randomElement(static::$secondaryFormats));
    }
